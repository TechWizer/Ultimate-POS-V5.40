<div class="row pos_form_totals">
	<div class="col-md-12">
		<table class="table table-condensed">
			...
			<tr>
				<?php if(!Gate::check('disable_discount') || auth()->user()->can('superadmin') || auth()->user()->can('admin')): ?>
					<td>
						<b>
...
</div><?php /**PATH E:\Shakya IT\Projects\pos-v5-base\resources\views/sale_pos/partials/pos_form_totals.blade.php ENDPATH**/ ?>