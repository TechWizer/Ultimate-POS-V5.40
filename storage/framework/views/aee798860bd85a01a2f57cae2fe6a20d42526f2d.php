...
<?php $__env->startSection('content'); ?>
    <div class="login-form col-md-12 col-xs-12 right-col-content">
        ...
        <form method="POST" action="<?php echo e(route('login'), false); ?>" id="login-form">
            ...
            <br>
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-flat btn-login"><?php echo app('translator')->get('lang_v1.login'); ?></button>
...
<?php echo $__env->make('layouts.auth2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Shakya IT\Projects\pos-v5-base\resources\views/auth/login.blade.php ENDPATH**/ ?>