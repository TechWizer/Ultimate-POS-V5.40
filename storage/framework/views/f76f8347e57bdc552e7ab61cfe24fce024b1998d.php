				...
				<div class="row">
					...
					<div class="col-md-6">
				        <div class="form-group">
				            ...
				            <?php echo Form::select('delivery_person_modal', $users, !empty($transaction->delivery_person) ? $transaction->delivery_person : null, ['class' => 'form-control select2 width-100','placeholder' => __('messages.please_select')]); ?>
...
<?php /**PATH E:\Shakya IT\Projects\pos-v5-base\resources\views/sale_pos/partials/edit_shipping_modal.blade.php ENDPATH**/ ?>