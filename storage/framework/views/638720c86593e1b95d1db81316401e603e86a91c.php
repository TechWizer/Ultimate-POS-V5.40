<script type="text/javascript">
	$(document).ready( function () {
	    ...
	    productions_table = $('#productions_table').DataTable({
	        ...
	        aaSorting: [[0, 'desc']],
	        ajax: {
	            url: '<?php echo e(action("\Modules\Manufacturing\Http\Controllers\ProductionController@index"), false); ?>',
	            "data": function ( d ) {
    	...
    	recipe_table = $('#recipe_table').DataTable({
	        processing: true,
	        serverSide: true,
	        ajax: '<?php echo e(action("\Modules\Manufacturing\Http\Controllers\RecipeController@index"), false); ?>',
	        columnDefs: [
	            {
	                targets: [0, 5, 6, 7],
	                orderable: false,
...
</script><?php /**PATH E:\Shakya IT\Projects\pos-v5-base\Modules\Manufacturing\Providers/../Resources/views/layouts/partials/common_script.blade.php ENDPATH**/ ?>