            ...
            <div class="col-md-3">
              <div class="form-group">
                <div class="checkbox">
                  <br/>
                  <label>
                       <?php echo Form::checkbox('is_enable_service_staff_pin', 1, $user->is_enable_service_staff_pin, ['class' => 'input-icheck status', 'id' => 'is_enable_service_staff_pin']); ?> <?php echo e(__('lang_v1.enable_service_staff_pin'), false); ?>
                ...
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . __('lang_v1.tooltip_is_enable_service_staff_pin') . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
                </div>
              </div>
            </div>
            <div class="col-md-2 service_staff_pin_div <?php echo e($user->is_enable_service_staff_pin == 1 ? '' : 'hide', false); ?>">
              <div class="form-group">
                <?php echo Form::label('service_staff_pin', __( 'lang_v1.staff_pin' ) . ':'); ?>

                  <?php echo Form::password('service_staff_pin', ['class' => 'form-control','placeholder' => __( 'lang_v1.staff_pin' ) ]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Shakya IT\Projects\pos-v5-base\resources\views/manage_user/edit.blade.php ENDPATH**/ ?>