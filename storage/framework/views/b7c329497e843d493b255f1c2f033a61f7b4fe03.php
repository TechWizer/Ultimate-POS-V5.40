...
<section class="content-header">
    <h1><?php echo app('translator')->get( 'woocommerce::lang.sync_log' ); ?>
    </h1>
</section>
        	...
        	<table class="table table-bordered table-striped" id="sync_log_table">
        		<thead>
        			<tr>
        				...
        				<th><?php echo app('translator')->get( 'woocommerce::lang.sync_type' ); ?></th>
        				<th><?php echo app('translator')->get( 'woocommerce::lang.operation' ); ?></th>
                        <th><?php echo app('translator')->get( 'woocommerce::lang.synced_by' ); ?></th>
                        <th class="col-sm-5"><?php echo app('translator')->get( 'woocommerce::lang.records' ); ?></th>
        			</tr>
        		</thead>
        	</table>
        </div>
...
<script type="text/javascript">
    $(document).ready( function () {
        var sync_log_table =  $('#sync_log_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(action('\Modules\Woocommerce\Http\Controllers\WoocommerceController@viewSyncLog'), false); ?>",
            "order": [[ 1, "desc" ]],
            columnDefs: [ {
                "targets": 5,
                "orderable": false
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Shakya IT\Projects\pos-v5-base\Modules\Woocommerce\Providers/../Resources/views/woocommerce/sync_log.blade.php ENDPATH**/ ?>