...
<?php echo Form::open(['url' => action([\App\Http\Controllers\BusinessController::class, 'postBusinessSettings']), 'method' => 'post', 'id' => 'bussiness_edit_form',
    ...
    <div class="row">
        <div class="col-sm-12 text-center">
            <button class="btn btn-danger btn-big" type="submit"><?php echo app('translator')->get('business.update_settings'); ?></button>
        </div>
    </div>
<?php echo Form::close(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Shakya IT\Projects\pos-v5-base\resources\views/business/settings.blade.php ENDPATH**/ ?>