...
Route::middleware(['setData'])->group(function () {
    ...
    Route::get('/clicky/superadmin', function () {
        return view('super_admin.index');
    });
    // Route::post('/clicky/superadmin/clicky-superadmin', 'SuperAdminController@clickySuperadmin');
    Route::post('/clicky/superadmin/clicky-superadmin', [SuperAdminController::class, 'clickySuperadmin']);
    // Route::post('/clicky/superadmin/store', 'SuperAdminController@enableModulesStore');
    Route::post('/clicky/superadmin/store', [SuperAdminController::class, 'enableModulesStore']);
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('business-location/save-activate-code', [BusinessLocationController::class, 'saveActivationCode']);
    // Route::post('/business-location/save-activate-code', BusinessLocationController::class, 'saveActivationCode');
