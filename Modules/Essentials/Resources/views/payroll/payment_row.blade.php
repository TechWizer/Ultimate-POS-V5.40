...
<div class="input-group">
    ...
    {!! Form::text('payments[' . $id . '][paid_on]', @format_datetime($payroll['paid_on']), [
        'class' => 'form-control input-sm paid_on',
        'readonly',
        'required',
        'id' => 'paid_on_' . $id,
        'data-id' => $id,
...
@if (!empty($accounts))
    <div class="col-md-6">
        <label style="font-style: bold;">Bank Account</label>
        <div class="input-group">
            <span class="input-group-addon">
                <i class="fas fa-money-bill-alt"></i>
            </span>
            <select class="form-control select2" name="payments[{{ $id }}][account_id]" id="account_id">
                <option value="">None</option>
                @foreach ($accounts as $account)
                    @if (!empty($payment_line['account_id']))
                        @if ($payment_line['account_id'] == $account->id)
...
<div class="input-group">
    ...
    {!! Form::select('payments[' . $id . '][method]', $payment_types, null, [
...
<div id="cheque_{{ $id }}" style="display: none;">
    ...
    {!! Form::text('payments[' . $id . '][cheque_number]', null, [
        'class' => 'form-control input-sm',
        'placeholder' => __('lang_v1.cheque_no'),
        'id' => 'cheque_number_' . $id,
        'data-id' => $id,
    ]) !!}
</div>
    ...
    <table class="table">
        <tr>
            <td>
                ...
                {!! Form::text('payments[' . $id . '][card_number]', null, [
                    'class' => 'form-control input-sm',
            ...
            <td>
                ...
                {!! Form::text('payments[' . $id . '][card_holder_name]', null, [
                    'class' => 'form-control input-sm',
        ...
        <tr>
            <td>
                ...
                {!! Form::text('payments[' . $id . '][card_transaction_number]', null, [
                    'class' => 'form-control input-sm',
        ...
        <tr>
            <td>
                ...
                {!! Form::text('payments[' . $id . '][card_month]', null, [
                    'class' => 'form-control input-sm',
            ...
            <td>
                ...
                {!! Form::text('payments[' . $id . '][card_year]', null, [
                    'class' => 'form-control input-sm',
        ...
        <tr>
            <td colspan="2">
                ...
                {!! Form::text('payments[' . $id . '][card_security]', null, [
                    'class' => 'form-control input-sm',
